...
<div class="content-wrapper" style="min-height: 1604.62px;">
    ...
    <section class="content">
      {{ Form::open(['action' => ['Admin\CategoryController@save'], 'method' => 'POST','class' => 'form-horizontal']) }}
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input id="sort" type="text" name="sort" class="form-control  @error('sort') is-invalid @enderror">
                @error('sort')
                  <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
              ...
              <div class="form-group">
                <div class="form-check">
                  {{ Form::checkbox('active','', ['class' => 'form-check-input']) }}
